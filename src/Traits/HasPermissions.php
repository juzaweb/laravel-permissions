...
use Juzaweb\Permissions\Exceptions\PermissionDoesNotExist;
use Juzaweb\Permissions\Exceptions\WildcardPermissionInvalidArgument;
use Juzaweb\Permissions\Guard;
use Juzaweb\Permissions\PermissionRegistrar;
use Juzaweb\Permissions\WildcardPermission;
...
trait HasPermissions
{
    ...
    public function permissions(): BelongsToMany
    {
        return $this->morphToMany(
            \Juzaweb\Permissions\Models\Permission::class,
            'model',
