...
namespace Juzaweb\Permissions\Models;
...
use Juzaweb\Permissions\Exceptions\GuardDoesNotMatch;
use Juzaweb\Permissions\Exceptions\RoleAlreadyExists;
use Juzaweb\Permissions\Exceptions\RoleDoesNotExist;
use Juzaweb\Permissions\Guard;
use Juzaweb\Permissions\PermissionRegistrar;
use Juzaweb\Permissions\Traits\HasPermissions;
use Juzaweb\Permissions\Traits\RefreshesPermissionCache;
 ...
 * @method static Builder|Role permission(\Juzaweb\Permissions\Contracts\Permission|Collection|array|string|int $permissions)
